 ...
 * @type {React} Pure JS Carousel
 */

var slides = document.querySelectorAll('.CrazeCaroulsel__itemTestimonial'),
   bullets = document.querySelectorAll('.CrazeCaroulsel__bullets'),
   carouselCount = 0,
   scrollInterval,
   interval = 5000; //timeout interval between testimonials
